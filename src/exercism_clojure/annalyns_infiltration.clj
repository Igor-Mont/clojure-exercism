(ns exercism-clojure.annalynsInfiltration)
...
(defn can-free-prisoner?
  ...
  (let [warriors-sleeping? (and (not knight-awake?) (not archer-awake?))]
    (or
      (and dog-present? (not prisoner-awake?) warriors-sleeping?)
      (and dog-present? (not archer-awake?) knight-awake?)
      (and warriors-sleeping? prisoner-awake?)))
  )
